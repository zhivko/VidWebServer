...
class Crta(object):
    ...
    def plotlyLine(self):
        ...
        json = {"name": self.ime, "editable": 'true', "xref": 'x', "yref": 'y', "layer": 'above', "opacity": '1', "line": {"color": '#444', "width": 4, "dash": 'solid'}, "type": 'line', "x0": self.x0, "y0": self.y0, "x1": self.x1, "y1": self.y1, "label": "dict(text='Text above line', font=dict(size=20))"}
        return json
